    ...
    <section className="max-w-6xl mx-auto px-6 py-16">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="card hover:shadow-xl transition duration-300">
          <h2 className="text-3xl font-bold mb-6 text-pink-700">Passion for Photojournalism</h2>
        ...
        <div className="bg-gradient-to-br from-pink-600 to-pink-500 rounded-[2rem] p-10 shadow-xl text-white flex flex-col justify-center hover:shadow-2xl transition duration-300">
          <h2 className="text-3xl font-bold mb-6">Personal Vision</h2>

          <p className="text-lg leading-8 text-pink-50">
